...
extension Test {
  ...
  public var bundleURL: URL { cachedBundleURL }
  ...
  public func urlForTool(_ name: String) -> URL {
  ...
  public func inTempFolder<T>(_ body: (URL) async throws -> T) async throws -> T {

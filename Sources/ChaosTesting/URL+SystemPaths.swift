...
/// Private copy of some URL utilities.
/// These are copied into here to avoid this package having dependencies.
extension URL {
  ...
  internal init?(inSystemPathWithName item: String) {
  ...
  /// executable, and it can contain subdirectories; it just
  /// has to be in the system path somewhere.
  internal init(inSystemPathWithName item: String, fallback: String) {
